...
class SignUpPresenterTests: XCTestCase {
    func test_signUp_should_show_error_message_if_name_is_not_provided() {
        ...
        XCTAssertEqual(alertViewSpy.viewModel, makeRequiredAlertViewModel(fieldName: "O campo Nome é obrigatório"))
    }
    ...
    func test_signUp_should_show_error_message_if_email_is_not_provided() {
        ...
        XCTAssertEqual(alertViewSpy.viewModel, makeRequiredAlertViewModel(fieldName: "O campo Email é obrigatório"))
    }
    ...
    func test_signUp_should_show_error_message_if_password_is_not_provided() {
        ...
        XCTAssertEqual(alertViewSpy.viewModel, makeRequiredAlertViewModel(fieldName: "O campo Senha é obrigatório"))
    }
    ...
    func test_signUp_should_show_error_message_if_password_confirmation_is_not_provided() {
        ...
        XCTAssertEqual(alertViewSpy.viewModel, makeRequiredAlertViewModel(fieldName: "O campo Confirmar Senha é obrigatório"))
    }
