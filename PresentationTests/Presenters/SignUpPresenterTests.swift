...
class SignUpPresenterTests: XCTestCase {
    func test_signUp_should_show_error_message_if_name_is_not_provided() {
        ...
        alertViewSpy.observe { [weak self] viewModel in
            XCTAssertEqual(viewModel, self?.makeRequiredAlertViewModel(fieldName: "O campo Nome é obrigatório"))
            exp.fulfill()
        }
    ...
    func test_signUp_should_show_error_message_if_email_is_not_provided() {
        ...
        let exp = expectation(description: "waiting")
        alertViewSpy.observe { [weak self] viewModel in
            XCTAssertEqual(viewModel, self?.makeRequiredAlertViewModel(fieldName: "O campo Email é obrigatório"))
            exp.fulfill()
        }
    ...
    func test_signUp_should_show_error_message_if_password_is_not_provided() {
        ...
        let exp = expectation(description: "waiting")
        alertViewSpy.observe { [weak self] viewModel in
            XCTAssertEqual(viewModel, self?.makeRequiredAlertViewModel(fieldName: "O campo Senha é obrigatório"))
            exp.fulfill()
        }
    ...
    func test_signUp_should_show_error_message_if_password_confirmation_is_not_provided() {
        ...
        let exp = expectation(description: "waiting")
        alertViewSpy.observe { [weak self] viewModel in
            XCTAssertEqual(viewModel, self?.makeRequiredAlertViewModel(fieldName: "O campo Confirmar Senha é obrigatório"))
            exp.fulfill()
        }
    ...
    func test_signUp_should_show_error_loading_before_and_after_addAccount() {
